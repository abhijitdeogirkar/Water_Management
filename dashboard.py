...
with col_right:
    ...
    # --- ☀️ सुधारित सोलर ऊर्जा (Sofar) कार्ड (कॉम्पॅक्ट मोबाईल डिझाईन) ---
    ...
    with st.container(border=True):
        ...
        # 🌟 सर्वात मोठा बदल: मोबाईलवरही हे आकडे एका बाजूला एक (Side-by-side) राहतील.
        st.markdown(f"""
        <div style='display: flex; justify-content: space-around; align-items: center; margin-bottom: 10px;'>
            <div style='text-align: center;'>
                <div style='font-size: 13px; color: #666;'>सध्याची निर्मिती</div>
                <div style='font-size: 20px; font-weight: bold; color: #2e7d32;'>{live_power}</div>
            </div>
            <div style='text-align: center;'>
                <div style='font-size: 13px; color: #666;'>आजची एकूण वीज</div>
                <div style='font-size: 20px; font-weight: bold; color: #1565c0;'>14.5 kWh</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        
        solar_animation_html = f"""
        <div style='background-color: #f8f9fa; padding: 12px; border-radius: 8px; border: 1px solid #eee; margin-top: 5px;'>
