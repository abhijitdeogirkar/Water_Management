...
    # --- ☀️ सुधारित सोलर ऊर्जा (Sofar) कार्ड (लहान आकार आणि वास्तववादी चित्र) ---
...
        s1, s2 = st.columns(2)
        # फॉन्ट साईज लहान केली
        with s1: st.metric(label="सध्याची निर्मिती (Live)", value=live_power, delta="Active", help="kW मध्ये")
        with s2: st.metric(label="आजची एकूण वीज", value="14.5 kWh")
        
        # सोलर प्रवाहाचे सुधारित ॲनिमेशन (UI - लहान आकार आणि वास्तववादी चित्र)
...
                <div style='text-align: center; width: 40px;'><div style='font-size: 24px;'>🏡</div><div style='font-size: 11px; font-weight: bold; color:#555;'>Panels</div></div>
                <div style='flex-grow: 1; height: 4px; margin: 0 5px; {line_style}'></div>
                <div style='text-align: center; width: 40px;'><div style='font-size: 24px;'>🎛️</div><div style='font-size: 11px; font-weight: bold; color:#555;'>Inverter</div></div>
                <div style='flex-grow: 1; height: 4px; margin: 0 5px; {line_style}'></div>
                <div style='text-align: center; width: 40px;'><div style='font-size: 24px;'>⚡</div><div style='font-size: 11px; font-weight: bold; color:#555;'>Grid/Home</div></div>
            </div>
...
  0 draw_tank("Underground Tank", ug_lvl, tank_type="underground", inlets=ug_inlets)
