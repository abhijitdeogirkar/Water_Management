...
def draw_tank(tank_name, level_cm, tank_type="overhead", inlets=[]):
    ...
    # 🌟 सर्वात मोठा बदल: कठोर तांत्रिक लॉजिक
    wave_html = ""
    
    # अ. जर पाणी पडत नसेल, तर पृष्ठभागावर फक्त एक 'गडद निळ्या रंगाची सरळ आडवी रेषा' दाखावी
    if not is_pouring:
        # 'गडद निळा' रंग (%23 काढून # वापरावा)
    ...
    # ब. जर पाणी पडत असेल, तर 'रोल लाटा' (SVG) आणि 'मोमेंट' दोन्ही चालू करावे
    else:
        # समुद्राच्या लाटांचे (Ocean Waves) SVG, आता 'animation' सह
...
with col_right:
    ...
    with st.container(border=True):
        ...
        # सर्व बटणे डिफॉल्ट 'बंद' ठेवली आहेत
...
with col_left:
    ...
    # अंडरग्राउंड टाकी (दोन्ही सोर्सेस - UG पंप किंवा BW1 - चालू असल्यास पाणी पडेल)
    # टिप: अंडरग्राउंड टाकीचे इनलेट नेहमी चालू असतात, म्हणून त्यांना आपण थेट पल्स देऊ शकतो.
    # पण या कोडमध्ये लाटा थांबवण्यासाठी आपण smart pouring वापरू.
